...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'swifliving-showroom-build-xw1vp.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = '73f85d3bdb6f0f9ac02b43a88c6edf8d';
...
export async function storefrontApiRequest(query: string, variables: Record<string, unknown> = {}) {
  ...
  if (response.status === 402) {
    toast.error("Store billing required", {
      description: "Please upgrade your Shopify plan to continue.",
    });
    return;
  }
